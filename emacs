...
(defun куриллическое-ударение ()
  ...
  (cond ((eq (char-after (point)) 1040)
	 (progn (delete-forward-char 1)
		(insert-string "А́")))
	((eq (char-after (point)) 1045)
	 (progn (delete-forward-char 1)
		(insert-string "Е́")))
	((eq (char-after (point)) 1048)
	 (progn (delete-forward-char 1)
		(insert-string "И́")))
	((eq (char-after (point)) 1054)
	 (progn (delete-forward-char 1)
		(insert-string "О́")))
	((eq (char-after (point)) 1059)
	 (progn (delete-forward-char 1)
		(insert-string "У́")))
	((eq (char-after (point)) 1067)
	 (progn (delete-forward-char 1)
		(insert-string "Ы́")))
	((eq (char-after (point)) 1069)
	 (progn (delete-forward-char 1)
		(insert-string "Э́")))
	((eq (char-after (point)) 1070)
	 (progn (delete-forward-char 1)
		(insert-string "Ю́")))
	((eq (char-after (point)) 1071)
	 (progn (delete-forward-char 1)
		(insert-string "Я́")))
	((eq (char-after (point)) 1072)
	 (progn (delete-forward-char 1)
		(insert-string "а́")))
	((eq (char-after (point)) 1077)
	 (progn (delete-forward-char 1)
		(insert-string "е́")))
	((eq (char-after (point)) 1080)
	 (progn (delete-forward-char 1)
		(insert-string "и́")))
	((eq (char-after (point)) 1086)
	 (progn (delete-forward-char 1)
		(insert-string "о́")))
	((eq (char-after (point)) 1091)
	 (progn (delete-forward-char 1)
		(insert-string "у́")))
	((eq (char-after (point)) 1099)
	 (progn (delete-forward-char 1)
		(insert-string "ы́")))
	((eq (char-after (point)) 1101)
	 (progn (delete-forward-char 1)
		(insert-string "э́")))
	((eq (char-after (point)) 1102)
	 (progn (delete-forward-char 1)
		(insert-string "ю́")))
	((eq (char-after (point)) 1103)
	 (progn (delete-forward-char 1)
		(insert-string "я́")))
	(t (forward-char))))
